...
export default class UnrealBloomEffect extends Effect {
  ...
  render(renderer, composer, inputRenderTarget, outputRenderTarget, finish) {
    ...
    if (finish) {
      this._blendPass.material.transparent =
        composer._tempClearColor[3] < 1 || !composer.clearColor;
      this._blendPass.renderStates.camera.rect.fromArray(
        composer._tempViewport
      );
    }
    ...
    this._tempRTList.forEach((rt, i) =>
      composer._renderTargetCache.release(rt, i + 1)
    );
  }
